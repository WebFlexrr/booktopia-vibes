          ...
          <div className="bg-card rounded-xl shadow-sm overflow-hidden">
            <div className="p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground mt-2">Sign up to start shopping for books</p>
              </div>
                  ...
                  {formData.password && (
                    <div className="mt-2">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-xs ml-2">{passwordStrength.label}</span>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="flex items-center text-xs">
                          <div className={`w-3 h-3 rounded-full mr-2 flex items-center justify-center 
                            ${/\d/.test(formData.password) ? 'bg-green-500' : 'bg-muted'}`}>
                        ...
                        <div className="flex items-center text-xs">
                          <div className={`w-3 h-3 rounded-full mr-2 flex items-center justify-center 
                            ${/[!@#$%^&*(),.?":{}|<>]/.test(formData.password) ? 'bg-green-500' : 'bg-muted'}`}>
